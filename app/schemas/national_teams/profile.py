...
class NationalTeamSquad(TransfermarktBaseModel):
...
class NationalTeamLeague(TransfermarktBaseModel):
...
class NationalTeamProfile(TransfermarktBaseModel):
    id: str
    url: str
    name: str
    ...
    squad: Optional[NationalTeamSquad] = None
    league: Optional[NationalTeamLeague] = None
