...
from app.api.endpoints import clubs, coaches, competitions, national_teams, players
...
api_router.include_router(national_teams.router, prefix="/national-teams", tags=["national-teams"])
